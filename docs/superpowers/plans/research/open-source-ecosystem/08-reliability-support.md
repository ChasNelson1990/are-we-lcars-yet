...
1. **Framework Computer (Laptop 13 / Laptop 16)** — License: hardware design files released openly per-repo (`FrameworkComputer/EmbeddedController` = CC-BY-4.0, `FrameworkComputer/Framework-Laptop-13` = Apache-2.0) · Status: actively maintained, EmbeddedController pushed 2026-06-25, Framework-Laptop-13 repo pushed 2026-07-14, Pro line of the Laptop 13 announced April 21, 2026 · Verified 2026-07-21: `gh api repos/FrameworkComputer/EmbeddedController` and `gh api repos/FrameworkComputer/Framework-Laptop-13` (both `archived: false`, recent `pushed_at`), plus a live fetch of frame.work confirming the parts marketplace (battery $49, display $179, mainboard $449+) and free published repair guides.
